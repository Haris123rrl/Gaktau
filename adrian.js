...
module.exports = conn = async (conn, m, chatUpdate, store) => {
    try {
        ...
        //buttons Tambahan
        const ntiktok = ('© nipgx')
        const ini_mark = `6285936162097@s.whatsapp.net`
        const ownernya = ownernomer + '6285936162097@s.whatsapp.net'
        
//━━━━━━━━━━━━━━━[ FAKE ]━━━━━━━━━━━━━━━━━//
	    const ftroli = {
    key: {
        fromMe: false,
        "participant": "6285936162097@s.whatsapp.net",
    ...
    "message": {
        orderMessage: {
            ...
            message: `${ttname}`,
            orderTitle: 'haris',
            sellerJid: '6285936162097@s.whatsapp.net'
        }
    },
    contextInfo: {
        "forwardingScore": 999,
...
const fgclink = {
    ...
    "message": {
        "groupInviteMessage": {
            "groupJid": "120363165757431692@g.us",
            "inviteCode": "m",
            "groupName": `${ttname}`,
            "caption": `${ttname}`,
            'jpegThumbnail': thumb,
